...
designBased <- function(records, sampling, MeanOfMeans=F){
  ...
  indParameters <- RstoxFDA::ComputeIndividualSamplingParameters(StoxBioticData = records, 
...
ratioEst <- function(records, sampling, landings, MeanOfMeans=F){
  ...
  populationEstimates <- RstoxFDA::AnalyticalRatioEstimate(populationEstimates, landings, "IndividualRoundWeight", "TotalDomainWeight", StratificationVariables = "Species")
